...
export const deleteForCommitComment: ApiHeroEndpoint<
  { repo: string; reactionId: number; commentId: number; owner: string },
  void
> = {
...
export const deleteForIssue: ApiHeroEndpoint<
  { repo: string; reactionId: number; issueNumber: number; owner: string },
  void
> = {
...
export const deleteForRelease: ApiHeroEndpoint<
  { repo: string; releaseId: number; reactionId: number; owner: string },
  void
> = {
